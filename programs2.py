...
for i in cate:
    print("Category name:", i.name, "Category code", i.code)
    for j in products:
...
#                 self.child_name = self.parent.parent.parent.name
#                 return f"{self.child_name}>{self.parent.parent.name}>{self.parent.name}>{self.name}"
#             else:
